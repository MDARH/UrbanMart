            ...
            <div class="modal-body">
                <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" value="" placeholder="{{ translate('Email') }}" name="email" id="customer_email" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="{{ translate('Password') }}" name="password" id="customer_password">
                    </div>
