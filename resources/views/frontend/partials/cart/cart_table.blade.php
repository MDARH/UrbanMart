            ...
            @foreach ($carts as $key => $cart_item)
                @php
                    ...
                    if($cart_item && $product) {
                        // Mohammad Hassan - Use stored unit_price from cart for variant-specific pricing
                        $unit_price = isset($cart_item['unit_price']) && $cart_item['unit_price'] > 0
                            ? $cart_item['unit_price']
                            : cart_product_price($cart_item, $product, false, false);
