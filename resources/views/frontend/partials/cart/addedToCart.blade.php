<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="media mb-4">
        ...
        <div class="media-body mt-2 text-left d-flex flex-column justify-content-center">
            ...
            {{-- Grand Total Display --}}
            <div class="row mt-2">
                <div class="col-sm-5 fs-14 fw-400 text-secondary">
                    <div>{{ translate('Grand Total') }}</div>
                </div>
                <div class="col-sm-7">
                    <div class="fs-16 fw-700 text-primary">
                        <strong>
                            {{-- This now shows the correct total sent from the form --}}
