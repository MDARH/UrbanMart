...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}" style="margin-left: 70px;">
    <span class="mr-2">
