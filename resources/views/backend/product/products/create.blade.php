                        ...
                        <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-md-3 col-from-label">{{ translate('Product Price Tiers') }}</label>
                                        <div class="col-md-9">
                                            <div class="mb-3">
                                                <small
                                    ...
                                    <!-- External link -->
                                    <div class="form-group row">
                                        <label class="col-md-3 col-from-label"> {{ translate('External link') }} </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-from-label">
                                            {{ translate('External link button text') }} </label>
                                        <div class="col-md-9">
                                            <input type="text"
